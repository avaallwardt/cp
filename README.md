# Solving cp problems!
7/29/26
- speeding ticket (usaco 2015 december bronze)
- bovine cow (usaco 2017 us open bronze)
...
- daisy chains (usaco 2020 december bronze) (found an optimized $O(n^2)$ solution instead of $O(n^3)$)
